...
public class PurchaseRecordProductAdapter extends ArrayAdapter<Product> {

    private List<Product> productData;
    private Context mContext;
    private int resourceId;

    public PurchaseRecordProductAdapter(Context context, int resourceId, List<Product> data) {
